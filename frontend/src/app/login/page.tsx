  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 p-4 transition-colors duration-300">
      <div className="max-w-md w-full glass rounded-3xl border border-slate-200/50 dark:border-slate-800/50 p-8 shadow-2xl flex flex-col items-center">
        ...
        <h2 className="text-2xl font-bold text-slate-950 dark:text-white mb-1">Welcome Back</h2>
        <p className="text-sm text-slate-500 dark:text-slate-400 mb-8">Sign in to your Tickora account</p>
